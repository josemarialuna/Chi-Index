...
## PARAMETERS##
filePath = "C:/datasets/brca/"  # untreated-9-47k #pos-37k.tif
fileName = "brca_autoencoded.csv"
k = 4
classIndex = -1
idIndex = 0
...
X = np.array(df.drop("Class", axis=1).drop("id", axis=1))


kmeans = cluster.KMeans(n_clusters=k, n_init=100, max_iter=500, init='random', random_state=101287,
                        precompute_distances=False, n_jobs=4).fit(X)
